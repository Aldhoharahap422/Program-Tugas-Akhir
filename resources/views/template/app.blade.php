...
<footer>
  <div class="row expanded callout secondary" style="margin-bottom: 0;">
    ...
    <div class="small-6 large-3 columns">
        <p class="lead padding-3">Informasi</p>
            <ul class="menu vertical">
                    <li style="padding-bottom: 16px;"><ion-icon name="logo-whatsapp"></ion-icon> 0881-6760-251 (Basecamp)</li>
                    <li style="padding-bottom: 16px;"><ion-icon name="logo-whatsapp"></ion-icon> 0857-9921-4034 (Basecamp)</li>
            </ul>
