...
class BeritaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('gambar')) {
            ...
            // Periksa apakah ukuran file melebihi batas maksimum (4 MB)
            if ($fileSize > 2 * 2048 * 2048 || $fileSize === False) {
                // File terlalu besar, kembalikan respons dengan pesan kesalahan
                return redirect()->back()->with('gambar', 'Ukuran file tidak lebih dari 4 mb');
            }
