    ...
    <ol>
        <li><h5>Registrasi Akun Pendaki</h5>
            <ol style="list-style-type: lower-alpha;">
                <li>Masuk ke website Gunung Slamet via Dipajaya https://slametdipajaya.my.id/ lalu Klik “Daftar".</li>
        ...
        <li style="margin-top: 20px;"><h5>Booking Online</h5><br><img src="{{ asset('alur-booking.png') }}" alt="" width="1350" height="640"  style="margin-left: auto; margin-right: auto; display: block; margin-top: 20px;">
            <ol style="list-style-type: lower-alpha;">
                <li>Buka halaman resmi Booking Online Pendakian Gunung Slamet via Dipajaya https://slametdipajaya.my.id/.</li>
                ...
                <li>Jika pembayaran melalui transfer, Harap mengirimkan bukti transfer melalui Whatsapp ketua rombongan terdaftar. Nomor Whatsapp basecamp dapat dilihat di halaman paling bawah website atau hubungi WA : 0881-6760-251 (Basecamp)</li>
                <li>Jika pembayaran melalui On site, ketua rombongan wajib menunjukkan kode pendakinya ke pihak basecamp untuk diperiksa total biaya yang harus dibayarkan. Untuk biaya dikenakan sebesar Rp. 25.000/Orang.</li>
            </ol>
        </li>
